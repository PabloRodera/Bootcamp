...
public class CarMapper {
    ...
    public CarEntity toCarEntity(CarDto carDto) {
        ...
        BrandEntity brandEntity = brandRepository.findById(carDto.getBrand_id())
                .orElseThrow(() -> new IllegalArgumentException("BrandEntity with id " + carDto.getBrand_id() + " not found"));
    ...
    public CarDto toCarDto(CarEntity carEntity) {
        ...
        carDto.setBrand_id(carEntity.getBrand().getId());
